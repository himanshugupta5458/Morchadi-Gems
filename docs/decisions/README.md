...
| [040](ADR-040-postgres-for-orders.md) | Postgres for orders and CRM, alongside the JSON catalogue rather than replacing it | Accepted — narrows the no-database row of [001](ADR-001-tech-stack.md); the catalogue stays in `data/products.json` |
