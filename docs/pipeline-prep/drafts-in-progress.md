...
| P153 | DC Jewelry Cross Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `191` |
| P154 | Cushion Halo CZ Gold-Plated Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `192` |
| P155 | Floral Halo Solitaire CZ Gold-Plated Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `193` |
...
| P172 | Rose Gold-Plated AD Stone Band Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `217` |
| P173 | Double Disk CZ Gold-Plated Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `218` |
| P174 | 3mm crystal jelly glass bangles (Set of 8) | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `471` |
| P175 | DC Jewelry Music Spark Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `472` |
| P176 | DC Jewelry Trio Spark Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `473` |
| P177 | DC Jewelry butterfly adjustable ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `474` |
| P178 | DC Jewelry stone band ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `475` |
| P179 | DC Jewelry double rose adjustable ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `476` |
| P180 | DC Jewelry emerald cut adjustable ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `477` |
| P181 | DC Jewelry geometric flower adjustable ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `478` |
| P182 | Infinity Crossover CZ Gold-Plated Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `479` |
| P183 | Baguette Solitaire CZ Gold-Plated Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `481` |
| P184 | Pavé CZ Gold-Plated Band Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `482` |
| P185 | Princess Bar CZ Gold-Plated Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `483` |
| P186 | Rectangular Baguette CZ Gold-Plated Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `484` |
| P187 | Round Pavé CZ Gold-Plated Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `485` |
| P188 | Rectangle CZ Stone Gold-Plated Statement Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `486` |
| P189 | Leaf Marquise CZ Stone Gold-Plated Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `487` |
| P190 | Dual Design Gold-Plated Adjustable Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `488` |
| P191 | Leaf Vine Design Gold-Plated Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `489` |
| P192 | Interlocked Circle Knot Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `490` |
| P193 | Butterfly Design Dual Band Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `491` |
| P194 | Rose Gold Crystal Rope Bar Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `492` |
| P195 | Elegant Princess Cut Solitaire Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `493` |
| P196 | Teardrop CZ Gold-Plated Designer Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `494` |
| P197 | Cute Bow Knot CZ Gold-Plated Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `495` |
| P198 | Floral Halo Solitaire CZ Silver-Plated Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `496` |
| P199 | Heart Solitaire CZ Gold-Plated Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `497` |
| P200 | Rose Gold-Plated Oval AD Solitaire Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `498` |
...
| P208 | Elegant Adjustable Floral Gold-Plated Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `507` |
...
| P217 | Green Rain Drop Glass Bangles (12 Piece) | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `516` |
| P218 | Satrangi Sitare &#124; Multicolor Glitter Glass Bangle Set of 12 | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `517` |
| P219 | Anti Tarnish Lover Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `519` |
| P220 | Anti-Tarnish Geometric Band Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `520` |
| P221 | Anti Tarnish Elysian Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `522` |
| P222 | Anti Tarnish Nova Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `523` |
| P223 | Anti Tarnish Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `524` |
| P224 | Anti-Tarnish Gold-Plated Open Adjustable Stone-Studded Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `525` |
| P225 | Anti-Tarnish Infinity Link Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `526` |
| P226 | Anti-Tarnish Double Band Gold-Plated Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `527` |
| P227 | Anti-Tarnish Gold-Plated Crystal Cut-Out Band Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `528` |
| P228 | Anti-Tarnish Sparkle Band Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `529` |
| P229 | Anti-Tarnish Triple Band Adjustable Wave Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `530` |
| P230 | Anti Tarnish Solitaire Spark Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `531` |
| P231 | Anti Tarnish Infinity Glam Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `532` |
| P232 | Anti-Tarnish "Duo Gleam" Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `533` |
| P233 | Anti-Tarnish Stone-Studded Adjustable Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `534` |
| P234 | Anti-Tarnish V-Shape Chevron Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `535` |
| P235 | Anti Tarnish Twisted Solitaire Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `536` |
| P236 | Anti Tarnish Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `537` |
...
| P274 | Anti-Tarnish Red & White Modernist Enamel Kada | `bracelets` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `660` |
| P275 | Anti-Tarnish Monochrome Block Enamel Kada | `bracelets` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `661` |
...
| P286 | Transparent Golden Glass Stone Bangles | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `678` |
| P287 | Olive Green Glass Stone Bangles | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `679` |
| P288 | Dual-Tone Glass Stone Bangles | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `680` |
...
| P302 | Minimalist North Star Pendant Necklace - Anti-Tarnish Gold Jewelry | `pendants` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `712` |
| P303 | Textured Heart Pendant Necklace with Diamond - Anti-Tarnish Gold Jewelry | `pendants` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `714` |
| P304 | Vintage-Inspired Key Pendant Necklace | `pendants` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `715` |
| P305 | Anti tarnish Charm Necklace | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `717` |
| P306 | Starfish Pendant Beaded Necklace | `pendants` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `718` |
| P307 | Multi-Charm Butterfly and Floral Necklace - Anti-Tarnish Gold Jewelry | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `719` |
| P308 | Designer-Inspired Coin and Initial Necklace - Anti-Tarnish Gold Jewelry | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `720` |
| P309 | Floral Heart Locket Necklace | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `721` |
| P310 | Anti tarnish Heart Pendant  Necklace | `pendants` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `722` |
| P311 | Emerald Heart Pendant Necklace | `pendants` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `723` |
| P312 | Pink Rain Drop Glass Bangles (12 Piece) | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `730` |
| P313 | Set of 12 Multicolor RainDrop Glass Bangles | _(none)_ | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `731` |
| P314 | Set of 12 Colorful Festival RainDrop Glass Bangles | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `732` |
| P315 | Mint Green & White CZ Choker Necklace Set | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `737` |
| P316 | Green Kundan Pearl Choker Necklace Set | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `738` |
| P317 | Minimal Heart Necklace & Bracelet Set | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `739` |
...
| P326 | Silver-Plated Pink Drop Earrings with CZ Stones | `earrings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `752` |
| P327 | Multicolor Crystal Cluster Stud Earrings | `earrings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `753` |
| P328 | Korean Pink Square Adjustable Ring | _(none)_ | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `754` |
| P329 | Black Stone Silver Ring | _(none)_ | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `755` |
| P330 | Vintage Stone Silver Ring | _(none)_ | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `756` |
| P331 | Red Stone Silver Ring | _(none)_ | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `757` |
...
| P341 | Royal Blue Glass Bangles Set of 12 with Golden Dotted Work | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `775` |
| P342 | Gold-Tone Glass Bangles Set of 12 with Crystal Dotted Work | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `776` |
| P343 | Emerald Green Glass Bangles Set of 12 with Golden Dotted Work | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `777` |
| P344 | Navy Blue Glass Bangles Set of 12 with Golden Dotted Work | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `778` |
| P345 | Transparent Glass Bangles Set of 12 with Golden Dotted Work | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `779` |
| P346 | Lime Green Glass Bangles Set of 12 with Crystal Dotted Work | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `780` |
| P347 | Set of 12 Olive Green Glass Bangles with Gold Bead Detailing | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `781` |
| P348 | Rust Orange Glass Bangles – Set of 12 with Gold Bead Accents | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `782` |
| P349 | Hot Pink Glass Bangles – Set of 12 with Gold Bead Detailing | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `783` |
| P350 | Ivory White Glass Bangles – Set of 12 with Gold Bead Detailing | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `784` |
...
| P367 | Trending Gold Plated Set of 3 Stackable Finger Rings | `gift-hampers` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `808` |
| P368 | Gold Plated Contemporary Stackable Rings Set of 11 | `gift-hampers` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `809` |
...
| P389 | Kashmiri Red Tulip Kundan Bracelet Watch for Women | `watches` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `839` |
| P390 | Kashmiri Yellow Lotus Elephant Meenakari Bracelet Watch | `watches` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `840` |
| P391 | Kashmiri Blue Meenakari Kundan Bracelet Watch | `watches` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `841` |
...
| P404 | Pink Petal Cherry Blossom Spring Pendant Necklace for Women | `pendants` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `856` |
...
| P408 | Brass Initial Letter adjustable ring (Silver) | _(none)_ | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `861` |
...
| P417 | Set of 8 Viral Jelly Bangle (Blush Pink) | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `870` |
| P418 | Set of 8 Viral Jelly Bangle (Rose Pink) | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `871` |
| P419 | Set of 8 Viral Jelly Bangle (Peach) | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `872` |
| P420 | Set of 8 Viral Jelly Bangle (Pistachio Tint) | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `873` |
| P421 | Set of 8 Viral Jelly Bangle (Caramel Tint) | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `874` |
| P422 | Dainty Sparkling Butterfly Pendant Necklace | `pendants` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `875` |
| P423 | Layered Geometric Necklace – Gold | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `876` |
| P424 | Star Pendant Necklace in Gold Finish | `pendants` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `877` |
| P425 | Dainty Gold Bow Pendant Necklace | `pendants` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `878` |
| P426 | Gold Bow Necklace | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `879` |
| P427 | Elegant Gold Snake Chain Bow Necklace | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `880` |
...
| P433 | Puffed Heart Necklace on Sleek Snake Chain | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `886` |
| P434 | Mother of Pearl Heart Necklace in Gold | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `887` |
| P435 | Elongated Heart Pendant Necklace | `pendants` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `888` |
| P436 | Vintage-Style Filigree Heart Pendant on Chunky Rope Chain | `pendants` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `889` |
| P437 | Fan-Shaped Crystal Pendant Necklace | `pendants` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `891` |
| P438 | Silver Evil Eye Bracelet with Sparkling Crystals | _(none)_ | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `892` |
| P439 | Sparkling Silver Anchor & Evil Eye Bracelet | _(none)_ | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `893` |
| P440 | Silver Ship Wheel Evil Eye Bracelet | _(none)_ | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `894` |
| P441 | Silver Butterfly Evil Eye Bracelet | _(none)_ | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `895` |
| P442 | Silver Tree of Life Evil Eye Bracelet | _(none)_ | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `896` |
| P443 | Sparkling Silver Eyelash Evil Eye Bracelet | _(none)_ | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `897` |
...
| P459 | Gold Infinity Heart Bracelet | _(none)_ | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `915` |
| P460 | Gold Eiffel Tower Charm Bracelet | _(none)_ | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `916` |
| P461 | Gold Treble Clef Music Bracelet | _(none)_ | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `917` |
| P462 | Gold Heartbeat Lifeline Bracelet | _(none)_ | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `918` |
| P463 | Gold Bracelet Combo Set – Delicate Heart Link Chain & Minimalist Pearl Bracelet | _(none)_ | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `919` |
| P464 | Gold Chain Bracelet Combo – Elegant Rope & Paperclip Link Set | _(none)_ | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `920` |
| P465 | Gold Dainty Bracelet Combo Set – Minimalist Pearl Strand & Textured Link Chain | _(none)_ | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `921` |
| P466 | old Dainty Bracelet Combo Set – Minimalist Ball Chain & Shimmering Twisted Link Duo | _(none)_ | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `922` |
| P467 | Gold Dainty Bracelet Combo Set – Minimalist Link Chain & Elegant Leaf Motif Duo | _(none)_ | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `923` |
| P468 | Gold Paperclip & Heart Chain Bracelet Combo | _(none)_ | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `924` |
| P469 | Gold Dainty Bracelet Combo Set – Minimalist Beaded Twisted Chain & Sleek Box Chain | _(none)_ | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `925` |
| P470 | Gold Dainty Bracelet Combo Set – Minimalist Ball Chain & Beaded Link Duo | _(none)_ | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `926` |
| P471 | Gold Chain Bracelet Combo – Elegant Rope & Box Link Set | _(none)_ | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `927` |
...
| P482 | Gold-Plated Floral Cluster Nath – Sparkling White Stone Studded | `nose-pins` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `938` |
| P483 | Gold-Plated Traditional Nath – Ruby Red & White Stone Studded | `nose-pins` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `939` |
| P484 | Gold-Plated Traditional White Stone Nath – Sparkling Nose Ring with Pearl Drop | `nose-pins` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `940` |
| P485 | Gold-Plated Floral Teardrop Nath – Sparkling White Stone Studded | `nose-pins` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `941` |
| P486 | Gold-Plated Multi-Stone Traditional Nath – Vibrant Ruby, Emerald & White Stone | `nose-pins` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `942` |
| P487 | Gold-Plated Multi-Color Stone Traditional Nath – Vibrant Ruby & Emerald Green | `nose-pins` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `943` |
| P488 | Silver-Plated Dainty White Stone Nath – Sparkling CZ Studded with Teardrop Drop | `nose-pins` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `944` |
...
| P494 | Stainless Steel Textured Hoop Earrings | `earrings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `950` |
| P495 | Stainless Steel Engraved Hoop Earrings | `earrings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `951` |
| P496 | Stainless Steel Swirl Texture Hoop Earrings | `earrings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `952` |
| P497 | Stainless Steel Bamboo Style Hoop Earrings | `earrings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `953` |
| P498 | Stainless Steel Embossed Hoop Earrings | `earrings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `954` |
| P499 | Vibrant Pink Glass Bangle Set with Golden Ghoonghroo Accents – 16-Piece | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `955` |
| P500 | Elegant Lavender Glass Bangle Set with Golden Ghoonghroo Accents – 16-Piece | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `956` |
| P501 | Refreshing Sage Green Glass Bangle Set with Golden Ghoonghroo Accents – 16-Piece | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `957` |
| P502 | Deep Purple Glass Bangle Set with Golden Ghoonghroo Accents – 16-Piece | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `958` |
| P503 | Royal Maroon Glass Bangle Set with Golden Ghoonghroo Accents – 16-Piece | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `959` |
| P504 | Classic Grey Glass Bangle Set with Golden Ghoonghroo Accents – 16-Piece | `bangles` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `960` |
...
| P507 | Flower Leaf Design Shiny Colorful Necklace | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `968` |
...
| P512 | Blush pink Crystal Tulip Pendant | `pendants` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `973` |
| P513 | Gold Heart Locket Adjustable Open Ring | `rings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `974` |
...
| P516 | Elegant Red Rose Gold Stem Necklace | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `978` |
| P517 | Purple Enamel Floral Gold Pendant Necklace | `pendants` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `979` |
| P518 | White Enamel Magnolia Flower Gold Necklace | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `980` |
| P519 | Gold Crystal Floral Vine Cluster Necklace | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `981` |
| P520 | Gold Emerald Crystal Leaf Vine Necklace | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `982` |
| P521 | Luxurious  Fairy Bloom Floral Tulip Bracelet With Red Green Stones | `bracelets` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `983` |
| P522 | Colorful Zirconia Leaf Jewelry Set | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `984` |
| P523 | Baroque Pearl Tulip Toggle Clasp Bracelet | `bracelets` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `985` |
| P524 | Yellow Zirconia Tulip Gold Clavicle Chain | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `986` |
| P525 | Red Zirconia Tulip Gold Clavicle Chain | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `987` |
| P526 | Gold Tulip Cat's Eye Pull Bracelet | `bracelets` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `988` |
| P527 | Vibrant Pink Enamel Tulip Gold Bracelet | `bracelets` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `989` |
...
| P539 | Pastel Flower Anti Tarnish Floral Bracelet | `bracelets` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1005` |
| P540 | Rose Vine Anti Tarnish tulip Bracelet for Women | `bracelets` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1006` |
| P541 | Purple Floral Bow Anti Tarnish Bracelet | `bracelets` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1007` |
| P542 | Anti Tarnish Tulip Crystal Bracelet | `bracelets` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1008` |
| P543 | Emerald Vine Anti Tarnish Bracelet | `bracelets` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1009` |
| P544 | Blush Crystal Vine Bracelet | `bracelets` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1010` |
| P545 | Birthday Hamper for Her | `gift-hampers` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1011` |
| P546 | Pink Blossom Bow Bracelet for Women | `bracelets` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1012` |
| P547 | Purple Blossom Bow Bracelet for Women | `bracelets` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1013` |
| P548 | White Blossom Bow Bracelet for Women | `bracelets` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1014` |
| P549 | Anti Tarnish Gold Wheat Chain Bracelet | `bracelets` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1015` |
| P550 | Anti Tarnish Gold Ball Charm Bracelet for Women | `bracelets` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1016` |
| P551 | Anti Tarnish Gold CZ Tennis Bracelet for Women | `bracelets` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1017` |
| P552 | Anti Tarnish Gold CZ Tennis Bracelet with Square Solitaire Stone | `bracelets` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1018` |
| P553 | Anti Tarnish Gold Bead Bracelet with CZ Square Stone for Women | `bracelets` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1019` |
| P554 | Anti Tarnish Gold Double Layer Snake Chain Bracelet | `bracelets` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1020` |
| P555 | Anti Tarnish Pink tulip Leaf CZ Bracelet | `bracelets` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1021` |
| P556 | Anti Tarnish Dainty Gold CZ Tennis Bracelet | `bracelets` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1022` |
| P557 | Kashmiri Lotus Kundan Bracelet Watch | `watches` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1023` |
| P558 | Kashmiri Meenakari Bracelet Watch for Women | `watches` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1024` |
| P559 | Kashmiri Green Meenakari Kundan Pearl Mandala Bracelet Watch | `watches` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1026` |
...
| P564 | Red Ruby & Emerald Vine Necklace | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1033` |
| P565 | Purple & Emerald CZ Gold-Plated Anti-Tarnish Necklace | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1034` |
| P566 | Crystal White CZ Gold-Plated Anti-Tarnish Vine Necklace | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1035` |
| P567 | Pink Rose & Emerald CZ Gold-Plated Anti-Tarnish Necklace | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1036` |
| P568 | Amethyst Purple & Emerald CZ Gold-Plated Anti-Tarnish Necklace | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1037` |
| P569 | Pink & Purple Marquise Leaf Jewellery Set | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1038` |
| P570 | Diamond Petal Fringe Gold Stainless Steel Hoop Earrings | `earrings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1040` |
| P571 | Spiral Textured Chunky Gold-Plated Anti-Tarnish Hoop Earrings | `earrings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1041` |
| P572 | Spiral Texture Gold Stainless Steel Hoop Earrings | `earrings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1042` |
| P573 | Cross Hatch Gold Stainless Steel Hoop Earrings | `earrings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1043` |
| P574 | Twisted Rope Heart Gold Stainless Steel Hoop Earrings | `earrings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1044` |
| P575 | Crescent Moon Cutout Gold Stainless Steel Hoop Earrings | `earrings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1045` |
| P576 | Croissant Ribbed Gold Stainless Steel C-Hoop Earrings | `earrings` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1046` |
...
| P590 | Layered Satin Bow Hair Clip | `hair-accessories` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1060` |
| P591 | Tulip Bow Hair Clip | `hair-accessories` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1061` |
| P592 | Satin Scrunchie & Chocolate Hamper for Her | `gift-hampers` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1062` |
| P593 | Luxury Jewellery Gift Hamper for Her | `gift-hampers` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1063` |
...
| P598 | Birthday Decorated Jewelry Hamper for her | `gift-hampers` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1068` |
| P599 | Deluxe Jewelry Gift Hamper for her | `gift-hampers` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1069` |
| P600 | Luxury Raksha Bandhan Gift Hamper | `gift-hampers` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1070` |
| P601 | Traditional Rajasthani Pearl Beaded Bracelet Watch for Women | `watches` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1071` |
| P602 | Traditional Antique Gold Kundan Bracelet Watch for Women &#124; | `watches` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1072` |
...
| P612 | Vintage Anti-Tarnish Gold Green Dial Chain Bracelet Watch for Women | `watches` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1084` |
| P613 | Vintage Anti-Tarnish Gold Green Dial Bracelet Watch for Women | `watches` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1085` |
| P614 | Vintage Anti-Tarnish Gold Green Dial Bracelet Watch for Women | `watches` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1086` |
| P615 | Vintage Anti-Tarnish Gold White Dial Crystal Bracelet Watch for Women | `watches` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1087` |
| P616 | Vintage Anti-Tarnish Silver Blue Dial Mesh Bracelet Watch for Women | `watches` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1088` |
| P617 | Vintage Anti-Tarnish Gold White Dial Pearl Bracelet Watch for Women | `watches` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1089` |
...
| P619 | Vintage Anti-Tarnish Gold Green Dial Beaded Bracelet Watch for Women | `watches` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1091` |
...
| P621 | Vintage Gold Green Square Dial Mesh Bracelet Watch | `watches` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1093` |
| P622 | Vintage Anti-Tarnish Gold Emerald Green Dial Bracelet Watch | `watches` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1094` |
| P623 | Vintage Anti-Tarnish Gold Oval Link Emerald Dial Bracelet Watch | `watches` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1095` |
| P624 | Classic Mystery Jewellery Jar ✨ | `gift-hampers` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1096` |
| P625 | Surprise Mystery Jewellery Jar | `gift-hampers` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1097` |
| P626 | Premium Mystery Jewellery Jar | `gift-hampers` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1098` |
| P627 | Ultra Premium Mystery Jewellery Jar | `gift-hampers` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1099` |
| P628 | A Letter Necklace | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1100` |
| P629 | Aqua Blue Heart Necklace | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1101` |
| P630 | Gold Heart Wreath Necklace | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1102` |
| P631 | Green Heart Pendant Necklace | `pendants` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1103` |
| P632 | Emerald Green Baguette Necklace | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1104` |
| P633 | Emerald Green Stone Necklace | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1105` |
| P634 | White Crystal Heart Pendant Necklace | `pendants` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1106` |
| P635 | Sunburst Key Pendant Necklace | `pendants` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1107` |
| P636 | Birthstone Purple Bar Pendant Necklace | `pendants` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1108` |
| P637 | Purple Enamel Flower Pendant Necklace | `pendants` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1109` |
| P638 | Vintage-Style Amethyst Necklace with Crystal Leaf Halo | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1110` |
| P639 | Gold Tulip Necklace with Ruby | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1111` |
| P640 | 3D Red Rose Pendant Necklace | `pendants` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1112` |
| P641 | Clear Crystal Baguette Necklace | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1113` |
| P642 | Mother of Pearl Flower Medallion Necklace | `necklaces` | `queued` | 2026-08-24 | batch `2026-08-23-batch-01`, Odoo id `1114` |
